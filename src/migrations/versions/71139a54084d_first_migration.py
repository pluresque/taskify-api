...
Revises: 
Create Date: 2024-05-04 14:01:12.137868
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "created_by_id", fastapi_users_db_sqlalchemy.generics.GUID(), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "created_by_id", fastapi_users_db_sqlalchemy.generics.GUID(), nullable=False
        ),
